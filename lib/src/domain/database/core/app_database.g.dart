...
class AuthToken extends DataClass implements Insertable<AuthToken> {
  ...
  factory AuthToken.fromData(Map<String, dynamic> data, {String? prefix}) {
    final effectivePrefix = prefix ?? '';
    return AuthToken(
      accessToken: const StringType()
          .mapFromDatabaseResponse(data['${effectivePrefix}access_token'])!,
      idToken: const StringType()
          .mapFromDatabaseResponse(data['${effectivePrefix}id_token'])!,
...
class $AuthTokensTable extends AuthTokens
  ...
  late final GeneratedColumn<String?> accessToken = GeneratedColumn<String?>(
      ...
      type: const StringType(), requiredDuringInsert: true);
  final VerificationMeta _idTokenMeta = const VerificationMeta('idToken');
  @override
  ...
  AuthToken map(Map<String, dynamic> data, {String? tablePrefix}) {
    return AuthToken.fromData(data,
        prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
...
class NotificationData extends DataClass
  ...
  NotificationData(
      ...
      this.createdAt,
      this.updatedAt});
  factory NotificationData.fromData(Map<String, dynamic> data,
      {String? prefix}) {
    final effectivePrefix = prefix ?? '';
    return NotificationData(
      ...
      notificationType: const StringType()
          .mapFromDatabaseResponse(data['${effectivePrefix}notification_type']),
      notifierId: const StringType()
          .mapFromDatabaseResponse(data['${effectivePrefix}notifier_id']),
      notifierType: const StringType()
          .mapFromDatabaseResponse(data['${effectivePrefix}notifier_type']),
...
class $NotificationsTable extends Notifications
  ...
  late final GeneratedColumn<String?> notificationType =
      GeneratedColumn<String?>('notification_type', aliasedName, true,
          type: const StringType(), requiredDuringInsert: false);
  final VerificationMeta _notifierIdMeta = const VerificationMeta('notifierId');
  @override
  late final GeneratedColumn<String?> notifierId = GeneratedColumn<String?>(
      'notifier_id', aliasedName, true,
      type: const StringType(), requiredDuringInsert: false);
  final VerificationMeta _notifierTypeMeta =
